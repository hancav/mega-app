        ...
        <div class="mt-6">
            <div class="prose prose-slate prose-invert mx-auto max-w-4xl">
                ...
                <p>
                    ...
                    Terms, you may not access or use the Services. Mega-Site reserves the right to modify or replace these Terms at any time at its sole
                ...
                <p>
                    <strong>b. Mega-Site Account:</strong>
                ...
                <p>
                    ...
                    You are responsible for the content you provide, including compliance with applicable laws, rules, and regulations under
                    Portuguese and EU law. You retain all rights in, and are solely responsible for, the User Content you post to Mega-Site.
                </p>
                <p>
                    <strong>b. Rights Granted by You:</strong>
                    By posting content to the Services, you grant Mega-Site a non-exclusive, worldwide, royalty-free, sublicensable, and transferable
                    license to use, reproduce, distribute, prepare derivative works of, display, and perform the content in connection with the
                    Services.
                </p>
                ...
                <p>
                    ...
                    of Mega-Site and its licensors.
                </p>

                <h2>5. Termination</h2>
                <p>
                    Mega-Site may terminate or suspend your access to the Services immediately, without prior notice or liability, for any reason,
                    including if you breach the Terms.
                </p>

                <h2>6. Disclaimers and Limitations of Liability</h2>
                <p>
                    The Services are provided on an “as is” and “as available” basis. Mega-Site expressly disclaims all warranties of any kind, whether
                    express or implied, including, but not limited to, the warranties of merchantability, fitness for a particular purpose, and
                    non-infringement. Mega-Site will not be liable for any indirect, incidental, special, consequential, or punitive damages resulting
